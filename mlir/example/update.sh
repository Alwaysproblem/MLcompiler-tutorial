...
_mlir_example_dir="llvm-project/mlir/examples/toy"

[[ -d llvm-project ]] || git clone -b $_llvm_branch https://github.com/llvm/llvm-project.git
...
for dir in $_dirs; do
  ...
  pushd "$WORKSPACE/llvm-project/mlir/examples/toy/$dir"
